...
export default function SideNav() {
  ...
  // console.log("te state is :-", sidenav_status);
    ...
    <>
      <div className="flex h-full">
        ...
        <div className={`${View_Mode === "DARK" ? "bg-[rgb(10_33_62)] text-black" : "bg-slate-400 text-black"} overflow-auto p-2  transition-transform duration-300 ${sidenav_status ? "translate-x-0 w-[16rem]" : "-translate-x-full w-0"}`} >
          {
            (sidenav_selected_opt.toUpperCase() == "MESSGES") ?
              (
                <>
            ...
            (sidenav_selected_opt.toUpperCase() == "SEARCH") ?
              (
                <>
                  <Side_Bar_search></Side_Bar_search>
                  <p>it is search</p>
            ...
            (sidenav_selected_opt.toUpperCase() == "REELS") ?
              (
                <>
                  <p>it is reels</p>
                </>
              ) :
            (sidenav_selected_opt.toUpperCase() == "CALLS") ?
              (
                <>
                  <p>it is calls</p>
                </>
